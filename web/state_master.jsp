 ...
 <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <div class="registration">
        <h2 style="font-family: Audiowide">State Master</h2>
        ...
        <div class="form-info">
            <center>
                ...
                <%
                    ...
                    ResultSet rs = stmt.executeQuery("select state_id, state_name from tbl_state order by state_name");
                %>
                ...
                <table id="grid-selection" class="table table-condensed table-hover table-striped">
                    ...
                    <thead>
                        ...
                        <tr>
                            <th data-column-id="state_id" data-type="string" data-visible="false">State ID</th>
                            <th data-column-id="state_name" data-order="desc">State Master</th>
                ...
                <form action="state_master_qry.jsp" method="post"  name="myform" onsubmit="return check();"> 
                    <table> 

                        <tr>
                            <td><text  style="color: #FFF; float: left; font-family: Allerta Stencil; font-size: larger;" class="Category">State Master:&nbsp;</text></td>

                            <td><input type="text" placeholder="State Master" maxlength="45"  class="text2" id="state_name" name="state_name"></td>                         
                        </tr>
                    </table> 
                    </div>
                    <table>
