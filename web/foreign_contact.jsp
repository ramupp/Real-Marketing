<%-- 
    Document   : foreign_contact
    Created on : Nov 21, 2017, 11:37:22 AM
    Author     : RAMU
--%>
 ...
 <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <div class="registration">
        <h2 style="font-family: Audiowide">Foreign Contacts</h2>
        ...
        <div class="form-info">
            <center>
                ...
                <%
                    ...
                    ResultSet rs = stmt.executeQuery("select id, title, firstname, lastname, address1, tel_no, city,state, country from tbl_foreign_contacts order by id");
                %>
                ...
                <table id="grid-selection" class="table table-condensed table-hover table-striped">
                    ...
                    <thead>
                        ...
                        <tr>
                            <th data-column-id="id" data-type="string" style="display: none;" data-visible="false">ID</th>
                            <th data-column-id="title" data-order="desc" data-visible="false">Title</th>
                            <th data-column-id="fname" data-order="desc">First Name</th>
                            <th data-column-id="lname" data-order="desc">Last Name</th>
                            <th data-column-id="add" data-order="desc">Address</th>
                            <th data-column-id="tel_no" data-order="desc">Phone No.</th>
                            <th data-column-id="city_id" data-order="desc">City</th>
                            <th data-column-id="state_id" data-order="desc">State</th>
                            <th data-column-id="country_id" data-order="desc">Country</th>
                ...
                <form action="foreign_contact_qry.jsp" method="post"  name="myform" onsubmit="return check();"> 
                    <table> 
                       <tr>
                           <td><text  style="color: #FFF; float: left; font-family: Allerta Stencil; font-size: larger;" class="Category">Select Title: &nbsp;&nbsp;</text></td>

                           <td><Select id="mr" name="mr">
                        ...
                        <tr>
                            <td><text  style="color: #FFF; float: left; font-family: Allerta Stencil; font-size: larger;" class="Category">First Name:</text></td>
                             <td><input type="text" placeholder="First Name" maxlength="45"  class="text2" id="fname" name="fname"></td>                         
                        </tr>
                        <tr>
                            <td><text  style="color: #FFF; float: left; font-family: Allerta Stencil; font-size: larger;" class="Category">Last Name:</text></td>
                             <td><input type="text" placeholder="Last Name" maxlength="45"  class="text2" id="lname" name="lname"></td>                         
                        </tr>
                        <tr>
                            <td><text  style="color: #FFF; float: left; font-family: Allerta Stencil; font-size: larger;" class="Category">Address:</text></td>
                             <td><input type="text" placeholder="Address" maxlength="45"  class="text2" id="address1" name="address1"></td>                         
                        </tr>
                        
                         <tr>
                            <td><text  style="color: #FFF; float: left; font-family: Allerta Stencil; font-size: larger;" class="Category">Phone No.:</text></td>
                             <td><input type="text" placeholder="Phone Number" maxlength="45"  class="text2" id="tel_no" name="tel_no"></td>                         
                        </tr>
                    </table> 
                    </div>
                    <table>
