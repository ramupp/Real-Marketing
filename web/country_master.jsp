 ...
 <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <div class="registration">
        <h2 style="font-family: Audiowide">Country Master</h2>
        ...
        <div class="form-info">
            <center>
                ...
                <%
                    ...
                    ResultSet rs = stmt.executeQuery("select id, country_name from tbl_country order by country_name");
                %>
                ...
                <table id="grid-selection" class="table table-condensed table-hover table-striped">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th data-column-id="country_name" data-order="desc">Country Master</th>
                ...
                <form action="country_master_qry.jsp" method="post"  name="myform" onsubmit="return check();"> 
                    <table> 

                        <tr>
                            <td><text  style="color: #FFF; float: left; font-family: Allerta Stencil; font-size: larger;" class="Category">Country Master:&nbsp;</text></td>

                            <td><input type="text" placeholder="Contry Master" maxlength="45"  class="text2" id="country_name" name="country_name"></td>                         
                        </tr>
                    </table> 
                    </div>
                    <table>
